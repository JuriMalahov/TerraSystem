...
class Ui_CollectedMaterials(object):
    def setupUi(self, CollectedMaterials):
        ...
        self.redButton.setGeometry(QtCore.QRect(180, 430, 141, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.redButton.setFont(font)
        self.redButton.setObjectName("redButton")
        self.exportButton = QtWidgets.QPushButton(self.centralwidget)
        self.exportButton.setGeometry(QtCore.QRect(400, 430, 141, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.exportButton.setFont(font)
        self.exportButton.setObjectName("exportButton")
        self.graphButton = QtWidgets.QPushButton(self.centralwidget)
        self.graphButton.setGeometry(QtCore.QRect(610, 430, 141, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
    ...
    def retranslateUi(self, CollectedMaterials):
        ...
        self.graphButton.setText(_translate("CollectedMaterials", "Графики"))
